        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className="navbar-text">
            <div className="social-icon">
                <a href="https://www.linkedin.com/in/ray-quek-317394171/"><img src={linkedin} alt=""/></a>
                <a href="https://github.com/rayquekCW"><img src={github} alt=""/></a>
                <a href="mailto:ray.quek.2021@scis.smu.edu.sg"><img src={outlook} alt=""/></a>
            </div>
